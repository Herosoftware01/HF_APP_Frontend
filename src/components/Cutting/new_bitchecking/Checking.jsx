    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col">
      ...
      <main className="p-4 md:p-6 flex-1 flex flex-col gap-4 mx-auto w-full">
        ...
        <div className="bg-white p-4 md:p-6 rounded-3xl shadow-inner border border-gray-100">
          ...
          <div className="grid grid-cols-5 sm:grid-cols-8 md:grid-cols-12 lg:grid-cols-15 xl:grid-cols-19 2xl:grid-cols-28 gap-2 max-h-[40vh] overflow-y-auto pr-2 custom-scrollbar">
...
<button
  className='bg-green-500 hover:bg-green-600 active:scale-95 transition text-white w-10 h-10 rounded-lg text-xl font-bold shadow'
  onClick={() => {
...
/>
  ...
  <button
  className='bg-red-500 hover:bg-red-600 active:scale-95 transition text-white w-10 h-10 rounded-lg text-xl font-bold shadow'
  onClick={() => {
  ...
  <button
    ...
    onClick={async () => {
      ...
      try {
        ...
        if (data.status) {
          setSavedMap(prev => {
            const existing = prev[qrData.id] || [];
            return {
              ...prev,
              [qrData.id]: existing.includes(desc)
                ? existing
                : [...existing, desc]
            };
          });
    ...
    className={`ml-2 px-3 py-1 text-[10px] font-bold rounded-full
      ${isSaved(desc)
